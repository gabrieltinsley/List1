...
public class UIArrayList<T> implements IndexedUnsortedList<T> {
    public static final int DEFAULT_CAPACITY = 10;
    private T[] array;
    private int rear;

    /*
     * Default constructor that intializes a new empty list
     */
    public UIArrayList() {
    ...
    /**
     * Contructor intializes a new empty list of given capacity
     * @param initialCapacity
     */
    @SuppressWarnings("unchecked")
    public UIArrayList(int initialCapacity) {
